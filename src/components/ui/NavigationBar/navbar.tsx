...
<nav className="flex text-black dark:text-white items-center justify-between   bg-gradient-to-t from-transparent to-white dark:to-black px-8 py-4 sticky top-0">
  ...
  <div className="flex space-x-4">
 <ContactLinkBtn  path="mailto:srirmaph9812@gmail.com" name="Mail"/>
